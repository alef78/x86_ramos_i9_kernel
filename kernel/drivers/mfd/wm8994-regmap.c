...
static struct reg_default wm8958_defaults[] = {
	{ 0x0001, 0x0003 },    /* R1     - Power Management (1) */
	{ 0x0002, 0x6000 },    /* R2     - Power Management (2) */
	{ 0x0003, 0x0000 },    /* R3     - Power Management (3) */
	{ 0x0004, 0x0000 },    /* R4     - Power Management (4) */
	{ 0x0005, 0x0000 },    /* R5     - Power Management (5) */
	...
	{ 0x0410, 0x0000 },    /* R1040  - AIF1 ADC1 Filters */
	{ 0x0411, 0x0000 },    /* R1041  - AIF1 ADC2 Filters */
	{ 0x0420, 0x0280 },    /* R1056  - AIF1 DAC1 Filters (1) */
	{ 0x0421, 0x0010 },    /* R1057  - AIF1 DAC1 Filters (2) */
	{ 0x0422, 0x0200 },    /* R1058  - AIF1 DAC2 Filters (1) */
	{ 0x0423, 0x0010 },    /* R1059  - AIF1 DAC2 Filters (2) */
	{ 0x0430, 0x0068 },    /* R1072  - AIF1 DAC1 Noise Gate */
	{ 0x0431, 0x0068 },    /* R1073  - AIF1 DAC2 Noise Gate */
	{ 0x0440, 0x009C },    /* R1088  - AIF1 DRC1 (1) */
	{ 0x0441, 0x0844 },    /* R1089  - AIF1 DRC1 (2) */
	{ 0x0442, 0x0001 },    /* R1090  - AIF1 DRC1 (3) */
	{ 0x0443, 0x0108 },    /* R1091  - AIF1 DRC1 (4) */
	{ 0x0444, 0x0000 },    /* R1092  - AIF1 DRC1 (5) */
	{ 0x0450, 0x0098 },    /* R1104  - AIF1 DRC2 (1) */
	{ 0x0451, 0x0845 },    /* R1105  - AIF1 DRC2 (2) */
	{ 0x0452, 0x0000 },    /* R1106  - AIF1 DRC2 (3) */
	{ 0x0453, 0x0000 },    /* R1107  - AIF1 DRC2 (4) */
	{ 0x0454, 0x0000 },    /* R1108  - AIF1 DRC2 (5) */
	{ 0x0480, 0x029D },    /* R1152  - AIF1 DAC1 EQ Gains (1) */
	{ 0x0481, 0x6000 },    /* R1153  - AIF1 DAC1 EQ Gains (2) */
	{ 0x0482, 0x0EE6 },    /* R1154  - AIF1 DAC1 EQ Band 1 A */
	{ 0x0483, 0x0400 },    /* R1155  - AIF1 DAC1 EQ Band 1 B */
	{ 0x0484, 0x0468 },    /* R1156  - AIF1 DAC1 EQ Band 1 PG */
	{ 0x0485, 0x1EDA },    /* R1157  - AIF1 DAC1 EQ Band 2 A */
	{ 0x0486, 0xF0F2 },    /* R1158  - AIF1 DAC1 EQ Band 2 B */
	{ 0x0487, 0x0408 },    /* R1159  - AIF1 DAC1 EQ Band 2 C */
	{ 0x0488, 0x03BF },    /* R1160  - AIF1 DAC1 EQ Band 2 PG */
	{ 0x0489, 0x1E06 },    /* R1161  - AIF1 DAC1 EQ Band 3 A */
	{ 0x048A, 0xF15F },    /* R1162  - AIF1 DAC1 EQ Band 3 B */
	{ 0x048B, 0x040B },    /* R1163  - AIF1 DAC1 EQ Band 3 C */
	{ 0x048C, 0x056E },    /* R1164  - AIF1 DAC1 EQ Band 3 PG */
	{ 0x048D, 0x1A4E },    /* R1165  - AIF1 DAC1 EQ Band 4 A */
	{ 0x048E, 0xF319 },    /* R1166  - AIF1 DAC1 EQ Band 4 B */
	{ 0x048F, 0x040A },    /* R1167  - AIF1 DAC1 EQ Band 4 C */
	{ 0x0490, 0x0C45 },    /* R1168  - AIF1 DAC1 EQ Band 4 PG */
	{ 0x0491, 0x041B },    /* R1169  - AIF1 DAC1 EQ Band 5 A */
	{ 0x0492, 0x0507 },    /* R1170  - AIF1 DAC1 EQ Band 5 B */
	{ 0x0493, 0x4000 },    /* R1171  - AIF1 DAC1 EQ Band 5 PG */
	{ 0x0494, 0x0000 },    /* R1172  - AIF1 DAC1 EQ Band 1 C */
	{ 0x04A0, 0x6318 },    /* R1184  - AIF1 DAC2 EQ Gains (1) */
	{ 0x04A1, 0x6300 },    /* R1185  - AIF1 DAC2 EQ Gains (2) */
...
//add 8inch set by fjz
static struct reg_default wm8958_8inch_defaults[] = {
	{ 0x0001, 0x0003 },    /* R1     - Power Management (1) */
	{ 0x0002, 0x6000 },    /* R2     - Power Management (2) */
	{ 0x0003, 0x0000 },    /* R3     - Power Management (3) */
	{ 0x0004, 0x0000 },    /* R4     - Power Management (4) */
...
static bool wm8994_volatile_register(struct device *dev, unsigned int reg)
{
	...
	case WM8994_INTERRUPT_STATUS_1:
	case WM8994_INTERRUPT_STATUS_2:
   //wolfson add 2014-06-10 for eq/drc 
	case WM8994_AIF1_DRC1_1:
	case WM8994_AIF1_DRC1_2:
	case WM8994_AIF1_DRC1_3:
	case WM8994_AIF1_DRC1_4:
...
//add by fjz
struct regmap_config wm8958_8inch_regmap_config = {
	.reg_bits = 16,
	.val_bits = 16,

	.cache_type = REGCACHE_RBTREE,

	.reg_defaults = wm8958_8inch_defaults,
	.num_reg_defaults = ARRAY_SIZE(wm8958_8inch_defaults),
