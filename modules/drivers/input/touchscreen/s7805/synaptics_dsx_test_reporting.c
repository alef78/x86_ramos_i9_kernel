...
show_store_prototype(read_report_20)
...
static ssize_t test_sysfs_read_report_20_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{ 
	return 0;
}

static ssize_t test_sysfs_read_report_20_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	unsigned int ii;
	unsigned int jj;
